...
<body>
  {{-- test tailwind --}}
{{-- <div class="bg-purple-600 text-white text-3xl p-6 rounded-lg">
  Tailwind is working 
</div> --}}
      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            ...
            {{-- <a href="/" aria-current="page" class="{{request()->is("/") ? 'block bg-gray-900 rounded-md px-3 py-2 text-base font-medium text-white' : 'block rounded-md px-3 py-2 text-base font-medium text-white'}}">Home</a>
